...
export declare type LuxBadgeColor = 'primary' | 'warn' | 'accent' | string;
export declare type LuxBadgeSize = 'small' | 'medium' | 'large';
export declare type LuxBadgePosition = 'above after' | 'above before' | 'below before' | 'below after';
...
export class LuxBadgeNotificationDirective extends MatBadge implements OnChanges {
  ...
  @Input() luxBadgeColor: LuxBadgeColor = 'default';
  @Input() luxBadgeSize: LuxBadgeSize = 'medium';
  @Input() luxBadgePosition: LuxBadgePosition = 'above after';
