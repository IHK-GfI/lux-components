...
export declare type LuxDatepickerStartViewTypeAc = 'month' | 'year';
...
export class LuxDatepickerAcComponent extends LuxFormInputBaseClass implements OnInit, OnChanges, OnDestroy {
  ...
  @Input() luxStartView: LuxDatepickerStartViewTypeAc = 'month';
