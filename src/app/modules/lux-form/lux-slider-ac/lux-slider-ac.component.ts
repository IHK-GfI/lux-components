...
export declare type SLIDER_TICK_INTERVAL_AC = 'auto' | number;
export declare type SLIDER_COLORS_AC = 'primary' | 'accent' | 'warn';
...
export class LuxSliderAcComponent extends LuxFormComponentBase implements OnInit, OnChanges, OnDestroy {
