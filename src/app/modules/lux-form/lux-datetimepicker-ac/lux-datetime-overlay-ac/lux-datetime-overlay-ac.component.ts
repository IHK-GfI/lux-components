...
import { LuxDateFilterFnAc } from "../lux-datetimepicker-model-ac/lux-datetimepicker-types";
...
export class LuxDatetimeOverlayAcComponent implements MatDatepickerPanel<MatDatepickerControl<any>, any, any> {
  @Input() luxPickerInput: HTMLInputElement;
  @Input() luxStartView: 'month' | 'year' | 'multi-year' = 'month';
  @Input() luxCustomFilter: LuxDateFilterFnAc = undefined;
