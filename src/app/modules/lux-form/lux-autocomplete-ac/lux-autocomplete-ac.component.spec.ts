...
class LuxAutoCompleteInFormAttributeComponent {
  ...
  @ViewChild(LuxAutocompleteAcComponent) autocomplete: LuxAutocompleteAcComponent;
...
@Component({
  template: `
    <lux-autocomplete-ac luxLabel="Autocomplete" [luxOptions]="options" luxOptionLabelProp="label" luxLabel="Mock" [luxLookupDelay]="0">
    </lux-autocomplete-ac>
  `
})
