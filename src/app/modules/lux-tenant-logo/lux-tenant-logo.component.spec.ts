...
describe('LuxTenantLogoComponent', () => {
  ...
  describe('Tenant Logo Automatische Höhe Testen', () => {
    ...
    it('Tenant Logo Höhe automatisch setzen lassen', fakeAsync(() => {
      ...
      const expectedComputedHeight = "24px";
  ...
  describe('Tenant Logo Automatischer Variant Testen', () => {
    ...
    it('Tenant Logo Variant automatisch setzen lassen', fakeAsync(() => {
      ...
      const expectedComputedVariant1 = "unten";
      const expectedComputedVariant2 = "kurz";
      ...
      expect(luxImageEl.nativeElement.src).toContain("/assets/ihk-logos/" + testComponent.tenantKey + "_" + initialComputedVariant + ".svg");

      /* ___Änderungen durchführen___ */
      mediaQuerySubject.next("md");
      fixture.detectChanges();

      /* ___Nachbedingungen testen___ */
      expect(fixture.componentInstance.tenantVariant).toEqual("");
      expect(tenantLogoEl.componentInstance.luxTenantVariant).toEqual("");
      expect(luxImageEl.nativeElement.src).toContain("/assets/ihk-logos/" + testComponent.tenantKey + "_" + expectedComputedVariant1 + ".svg");
      ...
      expect(fixture.componentInstance.tenantVariant).toEqual("");
      expect(tenantLogoEl.componentInstance.luxTenantVariant).toEqual("");
      expect(luxImageEl.nativeElement.src).toContain("/assets/ihk-logos/" + testComponent.tenantKey + "_" + expectedComputedVariant2 + ".svg");
    }));
  });
});

@Component({
  template: ` <lux-tenant-logo [luxTenantKey]="tenantKey" [luxTenantVariant]="tenantVariant" [luxTenantLogoHeight]="tenantHeight"></lux-tenant-logo> `
})
