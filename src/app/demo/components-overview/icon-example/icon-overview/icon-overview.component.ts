...
export class IconOverviewComponent implements OnInit {
  ...
  iconObservable: Observable<LuxSvgIcon[]>;
  isLoading = false;
  copiedToClipboard = false;
  codeSnippet: string = '<lux-icon></lux-icon>';
  
  private _inputValue: string; // inputValue, des Suchfelds
  get inputValue(){
  ...
  set previewItem(item: LuxSvgIcon) {
  ...
  optionChanged(option: {label; value}) {
