...
import { LuxDateTimeStartViewAc } from "../../../modules/lux-form/lux-datetimepicker-ac/lux-datetimepicker-model-ac/lux-datetimepicker-types";
import {
...
export class DatetimepickerAuthenticExampleComponent {
  ...
  startView: LuxDateTimeStartViewAc = 'month';
